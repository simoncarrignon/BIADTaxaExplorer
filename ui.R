...
ui <- fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel("Botanical Taxa", 
      ...
      actionButton("custom_run_btn", "Run Analysisg"),
      actionButton("custom_clear_polygons_btn", "Clear Polygonsg"),
      downloadButton("custom_download_polygons", "Download Polygonsg"),
      downloadButton("custom_download_table", "Download Datag"),
      fluidRow(
        column(width = 6,
