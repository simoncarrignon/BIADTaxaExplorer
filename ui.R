...
ui <- fluidPage(
  ...
  selectInput("data_type_selector", "Select Data Type:", choices = c("Faunal", "Botanical"), selected = "Faunal"),  # New selector
  ...
  HTML("<p><b>Figure 1:</b> <br/> Raw data. Left: total number of NISP (or count) for each phase in each selected region. Right: percentage of each group in each phase for each area </p>"),
  fluidRow(
